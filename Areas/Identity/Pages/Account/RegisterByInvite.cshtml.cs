...
namespace AstraBugTracker.Areas.Identity.Pages.Account
{
    public class RegisterByInviteModel : PageModel
    {
        ...
        private readonly IBTProjectsService _btProjectsService;
        ...
        public RegisterByInviteModel(
            ...
            IBTInviteService btInviteService, IBTProjectsService bTProjectService)
        {
            ...
            _btProjectsService= bTProjectService;
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Add new user to designated project
                    await _btProjectsService.AddMemberToProjectAsync(Input.ProjectId, user);
